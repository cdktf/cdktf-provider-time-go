...
import (
	...
	_init_ "github.com/cdktf/cdktf-provider-time-go/time/v10/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdktf/cdktf-provider-time-go/time/v10/provider/internal"
...
func (t *jsiiProxy_TimeProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TimeProvider) ToHclTerraform() interface{} {
	var returns interface{}
