...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "createDuration", GoGetter: "CreateDuration"},
			_jsii_.MemberProperty{JsiiProperty: "createDurationInput", GoGetter: "CreateDurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "destroyDuration", GoGetter: "DestroyDuration"},
			_jsii_.MemberProperty{JsiiProperty: "destroyDurationInput", GoGetter: "DestroyDurationInput"},
