...
func (j *jsiiProxy_Static) Connection() interface{} {
...
func (j *jsiiProxy_Static) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Static) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewStatic(scope constructs.Construct, id *string, config *StaticConfig) Static {
	...
	if err := validateNewStaticParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Static{}
...
func (j *jsiiProxy_Static)SetConnection(val interface{}) {
...
func (j *jsiiProxy_Static)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Static)SetProvisioners(val *[]interface{}) {
...
func Static_IsConstruct(x interface{}) *bool {
	...
	if err := validateStatic_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
